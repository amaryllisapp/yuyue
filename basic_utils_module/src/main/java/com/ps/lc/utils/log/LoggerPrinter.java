...
import static com.ps.lc.utils.log.Logger.ASSERT;
import static com.ps.lc.utils.log.Logger.DEBUG;
import static com.ps.lc.utils.log.Logger.ERROR;
import static com.ps.lc.utils.log.Logger.INFO;
import static com.ps.lc.utils.log.Logger.VERBOSE;
import static com.ps.lc.utils.log.Logger.WARN;
...
class LoggerPrinter implements Printer {
    ...
    public void d(@Nullable Object object) {
        log(DEBUG, null, null, Utils.toString(object));
    }
    ...
    public void e(@Nullable Throwable throwable, @NonNull String message, @Nullable Object... args) {
        log(ERROR, null, throwable, message, args);
    }
     ...
     */
    private synchronized void log(int priority, @Nullable String tag,
                                  @Nullable Throwable throwable,
                                  @NonNull String msg,
