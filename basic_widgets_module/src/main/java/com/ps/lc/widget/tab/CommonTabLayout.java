...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidthEqualTitle = ta.getBoolean(R.styleable.CommonTabLayout_tl_indicator_width_equal_title, false);
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorWidth < 0) {
            ...
            if (mIndicatorWidthEqualTitle) {
                ...
                mIndicatorWidth = tvTitle.getPaint().measureText(tvTitle.getText().toString());
            }
